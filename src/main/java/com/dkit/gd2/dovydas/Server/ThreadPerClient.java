...
import com.dkit.gd2.dovydas.Core.MenuOptions;
import com.dkit.gd2.dovydas.Core.Packet;
...
public class ThreadPerClient implements Runnable
{
    ...
    public ThreadPerClient(Socket dataSocket){this.dataSocket = dataSocket;}
